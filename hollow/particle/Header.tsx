...
export function NavComp(props) {
    ...
    return <>
        ...
        <div id="mobile-nav" className="z-20">
            <div className="navbar  flex sm:hidden">
                <div className="flex-1">
                    <a className="btn btn-ghost normal-case text-xl text-primary">Merry</a>
                </div>
...
export default function Header(props: { name: string, active: string }) {
    ...
    return <div className={'home-header'}>
        ...
        <div className="hidden absolute frame-bg bottom-0 w-full sm:block">
            <Bg3d></Bg3d>
        </div>
