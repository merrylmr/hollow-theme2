...
gsap.timeline({defaults: {duration: 45}})
    ...
    .add(function () {
        ...
        main1.addEventListener('click', function (e) {
            ...
            for (var i = 0; i < $('.m1_cGroup').length; i++) {
                gsap.fromTo($('.m1_cGroup')[i], {transformOrigin: '50% 50%', scale: 1}, {
                    duration: 0.7 - i / 25,
                    scale: 0.9,
                    ease: 'back.in(10)',
                    yoyo: true,
    ...
    .fromTo('.m1Orb', {scale: 0, transformOrigin: '50% 50%'}, {
        duration: 0.8,
        scale: 1.5,
        ease: 'back.out(3)',
        stagger: 0.15,
    ...
    .fromTo('.m1OrbBlank', {opacity: 0}, {
        duration: 0.8, opacity: function (i) {
            return 0.2 + i / 7
    ...
    }, {rotation: '+=75', yoyo: true, repeat: -1}, 'orbs')
