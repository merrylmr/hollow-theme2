export default function Bg3d() {
    return <svg className="main1" width="100%" height="100%">
        <defs>
            <linearGradient id="grad1" x1="50%" y1="0%" x2="50%" y2="100%">
                <stop offset="10%" style={{"stop-color": "rgb(255,255,0)", "stop-opacity": 0.9}}></stop>
                <stop offset="99%" style={{"stop-color": "rgb(0,255,0)", "stop-opacity": "0.1"}}></stop>
            </linearGradient>
            <linearGradient id="grad2" x1="50%" y1="0%" x2="50%" y2="100%">
                <stop offset="25%" style={{"stop-color:": "rgb(0,255,200)", "stop-opacity": 0.1}}></stop>
                <stop offset="99%" style={{"stop-color": "rgb(200,255,0)", "stop-opacity": 0.2}}></stop>
            </linearGradient>
        </defs>
        ...
        <g className="m1_stage" opacity="0">
            <g className="m1_cGroup">
                ...
                <circle className="c1_line c1_line4" cx="0" cy="50" r="550" fill="none" stroke-width="2"
                        stroke="url(#grad1)"
                        opacity="0.4"/>
            ...
            <g className="m1_cGroup">
                ...
                <circle className="c1_line c1_line3" cx="0" cy="50" r="450" fill="none" stroke-width="2"
                        stroke="url(#grad1)"
                        opacity="0.4"/>
                ...
                <g className="m1Orb orb3">
                    ...
                    <path fill="#fff" opacity="0.7" d="M5.82,6.1c0-0.05,0-0.09,0-0.14c0-0.57-0.11-1.06-0.34-1.46c-0.23-0.4-0.62-0.6-1.19-0.6S3.32,4.18,3.05,4.73
            ...
            <g className="m1_cGroup">
                ...
                <circle className="c1_line c1_line2" cx="0" cy="50" r="360" fill="none" stroke-width="2"
                        stroke="url(#grad1)"
                        opacity="0.5"/>

                <g className="m1Orb orb2">
                    <circle cx="18.5" cy="7" r="24.5" fill="#983334" stroke-width="2.5" stroke="#b9393a"/>
                    <path fill="#fff" opacity="0.7" d="M1.75,10.47L0.24,2.78c0.35-0.15,0.69-0.23,1.03-0.23c0.34,0,0.58,0.08,0.74,0.23s0.26,0.43,0.32,0.83l0.57,3.4
            ...
            <g className="m1_cGroup">
                ...
                <circle className="c1_line c1_line1" cx="0" cy="50" r="279" fill="none" stroke-width="3"
                        stroke="url(#grad1)"
                        opacity="0.5"/>
                <g className="m1Orb orb1">
                    <circle cx="12.5" cy="7" r="17" fill="#653997"/>
                    <circle cx="12.5" cy="7" r="20" fill="none" stroke="#653997"/>
                    <path fill="#fff" opacity="0.7" d="M0.24,10.94c0.03-0.3,0.12-0.6,0.28-0.89s0.35-0.53,0.56-0.71c1.02,0.62,1.96,0.92,2.83,0.92
            ...
            <g className="m1_cGroup">
                <circle className="c1_solid" cx="0" cy="50" r="80" fill="#9e0" opacity="0.6"/>
            </g>
        </g>
    </svg>
}
